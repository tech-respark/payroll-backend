...
public class StaffDTO {
    ...
    public StaffResponseDTO toStaffResponseDTO() {
        ...
        dto.setSpeciality(this.speciality);
        dto.setExperience(this.experience);
        dto.setDescription(this.description);
        dto.setProfileImage(this.profileImage);
        dto.setEnableAppointments(this.enableAppointments);
        dto.setAllStaffAppointmentDashboard(this.allStaffAppointmentDashboard);
        dto.setWeeklyOff(this.weeklyOff);
        dto.setOwner(this.owner);
        dto.setAreaManager(this.areaManager);
        dto.setDoctor(this.doctor);
        dto.setConsultant(this.consultant);
        dto.setBirthDate(this.birthDate);
        dto.setJoiningDate(this.joiningDate);
        dto.setDesignation(this.designation);
        dto.setSalaryAmount(this.salaryAmount);
        dto.setReceiveOnlineNotifications(this.receiveOnlineNotifications);
        dto.setReceiveNotificationsOfAll(this.receiveNotificationsOfAll);
        dto.setIsBiometricIntegration(this.isBiometricIntegration);
        dto.setIsSyncedWithPersonnelManagement(this.isSyncedWithPersonnelManagement);
        dto.setIsSyncedWithBiometricDevice(this.isSyncedWithBiometricDevice);
        dto.setDisplayRank(this.displayRank);
        dto.setPwd(this.pwd);
        dto.setHasPassword(StringUtils.hasText(this.pwd));
        return dto;
    }
	@Override
	public String toString() {
		return "StaffDTO{" +
				...
				", allStaffAppointmentDashboard=" + allStaffAppointmentDashboard +
				", weeklyOff=" + Arrays.toString(weeklyOff) +
				", owner=" + owner +
				...
				", receiveOnlineNotifications=" + receiveOnlineNotifications +
				", receiveNotificationsOfAll=" + receiveNotificationsOfAll +
				", isBiometricIntegration=" + isBiometricIntegration +
				", isSyncedWithPersonnelManagement=" + isSyncedWithPersonnelManagement +
				", isSyncedWithBiometricDevice=" + isSyncedWithBiometricDevice +
				", applicationName='" + applicationName + '\'' +
				", displayRank=" + displayRank +
				", personnelJoiningDetails=" + personnelJoiningDetails +
				", personnelWorkExperienceDetailsList=" + personnelWorkExperienceDetailsList +
				", personnelBankAccountDetails=" + personnelBankAccountDetails +
				", personnelDocumentDetailsList=" + personnelDocumentDetailsList +
				", personnelEmergencyContactsList=" + personnelEmergencyContactsList +
				'}';
	}
}
